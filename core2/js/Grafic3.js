...
var EchartsAreaBasicLight3 = (function () {
    //
    ...
    var _areaBasicLightExample = function () {
      ...
      // Define element
      var area_basic_element = document.getElementById("area_basic3");
          ...
          series: [
            {
              name: "Importacion",
              type: "line",
              data: [1200, 412, 2162, 5144, 260, 830, 9710],
              areaStyle: {
                normal: {
                  opacity: 0.25,
                },
