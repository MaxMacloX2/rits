...
var EchartsAreaBasicLight5 = (function () {
    //
    ...
    var _areaBasicLightExample = function () {
      ...
      // Define element
      var area_basic_element = document.getElementById("area_basic5");
          ...
          series: [
            {
              name: "Importacion",
              type: "line",
              data: [10, 1224, 21, 54, 2602, 830, 710],
              areaStyle: {
                normal: {
                  opacity: 0.25,
                },
            ...
            },
            {
              ...
              data: [4430, 182, 4434, 791, 390, 30, 10],
            },
          ],
        });
      }
